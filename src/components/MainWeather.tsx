...
const MainWeather: React.FC<MainWeatherProps> = (props: MainWeatherProps) => {
    ...
    return (
        <div className="row">
            ...
            <div className="col d-flex flex-column justify-content-md-center">
                <img src={"https://openweathermap.org/img/wn/" + props.weather.weather[0].icon + "@4x.png"} alt="weather-icon" />
                <p className="fs-4">{upperCaseFormat(props.weather.weather[0].description)}</p>
            </div>
            <div className="col d-flex flex-column justify-content-md-center">
                <div className="row align-items-center">
